# <p align="center">🍾&thinsp;Welcome to HI_profile&thinsp;🎉</p>
...
今後もしばらくは `Flutter` で開発したいと考えています。

周辺の技術分野に関しても可能な限りキャッチアップしていきたいと考えて行動しています。

`Slack` で `#random` チャンネルがあれば色々ネタを投稿します。
...
（ View と Model を MVVM で明確に分離し、Model 部分のレイヤー化を Clean Architecture で行なっております）

他は MVP / Flux / Bloc（Flutter) で構築することが多かったです。
テストも可能な限り書きたいです。
...
## <img src="https://user-images.githubusercontent.com/36340609/153241207-f2a59ac1-4519-4af0-a974-ebc69f16c2b0.gif" />ラジオアプリ
一番最新のプロジェクトです。
ラジオアプリ開発に携わりました。
主に保守作業にて日々のバグフィックスを行なっていました。
